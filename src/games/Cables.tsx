...
import {IMidiInstrument} from '../midi/instruments/MidiInstrument';
import {MidiSynth} from '../midi/instruments/MidiSynth';
...
export class CablesGame implements Game {
  ...
  private readonly midiListeners: IMidiInstrument[];
